...
pub fn usage() void {
    info(
        ...
        \\  zvm select <version>       - select the specified version (if installed)
        \\  zvm delete <version>       - deletes the specified version (if installed)
        \\  zvm current                - outputs the current version
        \\
        \\Flags:
